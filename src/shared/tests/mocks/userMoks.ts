export const userMock = {
  ...
  roles: [
    {id: 2,value: "USER",description: "USER role"}
  ]
}

export const userAdminMock = {
  ...userMock,
  roles: [...userMock.roles, { id: 1, value: "ADMIN", description: "ADMIN role" }]
};

export const userModeratorMock = {
  ...userMock,
  roles: [...userMock.roles,{ id: 3, value: "MODERATOR", description: "MODERATOR role" }]
};
