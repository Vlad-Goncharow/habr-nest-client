      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className={s.item}>
          <div className={s.item__header}>
            <label htmlFor='title' className={s.item__title}>Категория Хаба</label>
            {
              errors?.category &&
        ...
        <div className={s.item}>
          <div className={s.item__header}>
            <label htmlFor='title' className={s.item__title}>Название Хаба</label>
            {
              errors?.title &&
        ...
        <div className={s.item}>
          <div className={s.item__header}>
            <label htmlFor='descr' className={s.item__title}>Описание Хаба</label>
            {
              errors?.description &&
              <span className={s.item__error}>{errors?.description.message}</span>
            }
          </div>
          <input 
            id='descr' 
