  ...
  return (
    <div
      className={classNames(s.item, {
        ...
        [s["heading-1"]]: props.children[0].props.children.props.block.type === 'custom-title-one',
        [s["heading-2"]]: props.children[0].props.children.props.block.type === 'custom-title-two',
        [s["heading-3"]]: props.children[0].props.children.props.block.type === 'custom-title-three',
      })}
