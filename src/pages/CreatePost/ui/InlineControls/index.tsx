...
const InlineControls: React.FC<InlineControlsProps> = ({ toggleBlockStyle, editorState }) => {
  //controls menu ref
    ...
    <>
      {
        ...
        <div ref={controlsRef} className={s.inlines} style={{ top: absoluteTop}}>
          {
            inlineStyles.map((el) =>
              <InlineControlBtn key={el.label} style={el.style} onToggle={toggleBlockStyle} />
            )
          }
        </div>
      }
