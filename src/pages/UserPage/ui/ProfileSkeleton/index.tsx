  ...
  return (
    <div className={s.wrapper}>
      ...
      >
        ...
        <rect x="0" y="60" rx="0" ry="0" width={Number(width) / 2} height="20" />
        <rect x="0" y="90" rx="0" ry="0" width={Number(width)} height="20" />
        <rect x="0" y="120" rx="0" ry="0" width={Number(width) / 2} height="20" />
        <rect x="0" y="150" rx="0" ry="0" width={Number(width)} height="20" />
        <rect x="0" y="180" rx="0" ry="0" width={Number(width) / 2} height="20" />
      </ContentLoader>
    </div>
  )
}
